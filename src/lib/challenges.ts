...
export const CHALLENGES: Challenge[] = [
    ...
    },
    {
        id: 'salto-cuantico',
        unit: 3,
        title: 'Operación Salto Cuántico',
        subtitle: 'Misión Cuántica en 4 Stages',
        description:
            'Un juego de 4 niveles concatenados donde usarás el Efecto Fotoeléctrico, Ondas de De Broglie, el Principio de Heisenberg y la Ecuación de Schrödinger para salvar a la humanidad.',
        maxXp: 500,
        unlockLevel: 1,
        icon: '🚀',
        color: '#8b5cf6',
